...
class MyVectorDBConnector:
    def __init__(self, collection_name, embedding_fn):
        ...
        '''先在终端运行 chroma run --path C:\开放原子\4.17\class_assistant\data\db '''
...
# chat_bot.createVectorDB(r"C:\开放原子\4.17\class_assistant\docs\信息系统概论_教材.pdf")
#
# response = chat_bot.chat("防火墙是什么？")
