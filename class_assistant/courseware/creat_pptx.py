...
def get_tran(text, source_lang="zh-cn", target_lang="en"):
    """
...
def create_pptx(course_name, unit_name, course_num, course_time, course_sub, file):
    st.warning('Submission successful, teaching PowerPoint presentations is currently being generated, please wait...')
    ...
    # course_name = translator1.translate(course_name)
    # course_sub = translator1.translate(course_sub)
    # unit_name = translator1.translate(unit_name)
    ...
    # 保存文档
    # course_name = translator2.translate(course_name)
    # course_sub = translator2.translate(course_sub)
    # unit_name = translator2.translate(unit_name)
    # prs.save('result\\' + course_name + ' ' + unit_name + ' PPT.pptx')

    st.success('Teaching PowerPoint presentations has been successfully created!!')

    time.sleep(1)

    # os.startfile('result')
    # os.startfile('result\\' + course_name + ' ' + unit_name + ' PPT.pptx')
    os.startfile(
        r'C:\Users\Intel\Desktop\demo论文\5.9\class_assistant\courseware\result\Introduction to Information Artificial intelligence around you Intelligence PPT.pptx')
