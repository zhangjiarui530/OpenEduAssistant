...
st.set_page_config(
    page_title="Outline&PPT",  # 页面标题
    page_icon=os.path.join("img", r"C:\Users\Intel\Desktop\demo论文\5.9\class_assistant\pic\logo.png"),  # 页面图标
    layout="wide",  # 页面布局
...
with st.sidebar:
    ...
    st.image(
        os.path.join(
            "img",
            r"C:\Users\Intel\Desktop\demo论文\5.9\class_assistant\pic\title5.png"
        ),
...
# elif selection == "智能出题":
#     question.app()
if selection == "Course Outline":
    outlineGenerate.app()
elif selection == "Teaching PPT":
    pptGenerate.app()
